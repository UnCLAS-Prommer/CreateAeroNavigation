...
public class CreateAeronauticsNavigation {
    // Define mod id in a common place for everything to reference
    public static final String MOD_ID = "create_aeronautics_navigation";
    ...
    public CreateAeronauticsNavigation(IEventBus modEventBus, ModContainer modContainer) {
